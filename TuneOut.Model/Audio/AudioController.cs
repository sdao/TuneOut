...
namespace TuneOut.Audio
{
    ...
    public class AudioController : INotifyPropertyChanged
    {
        ...
        static readonly AudioController _Default = new AudioController();
        ...
        /// </summary>
        TrackQueue _queue = new TrackQueue();
        MediaElement _media = new MediaElement();
        ...
        void _media_MediaFailed(object sender, ExceptionRoutedEventArgs e)
        {
            HandleStreamError();
        }
        ...
        AudioControllerStatus _Status = AudioControllerStatus.NotReady;
        /// <summary>
        ...
        TimeSpan _InternalPosition = TimeSpan.Zero;
        /// <summary>
    ...
    public class TrackEventArgs : EventArgs
    {
        ...
        readonly UniqueTrack _UniqueTrack;
        /// <summary>
    ...
    public class TrackChangedEventArgs : TrackEventArgs
    {
        ...
        public TrackChangedEventArgs(TrackEventArgs oldTrack, UniqueTrack newTrack) : base(oldTrack.UniqueTrack, oldTrack.StartTimeUtc, oldTrack.Position)
        {
            Contract.Requires(oldTrack != null);
            _NewUniqueTrack = newTrack;
        }

        readonly UniqueTrack _NewUniqueTrack;
        /// <summary>
