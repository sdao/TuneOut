...
namespace TuneOut.Audio
{
    ...
    public class TunesDataSource
    {
        ...
        /// <summary>
        /// Rests the default TunesDataSource and unlinks any remembered iTunes Library files.
        /// </summary>
        ...
        readonly IEnumerable<Album> _albums;
        [DataMember(Name="PlaylistsFlat")]
        readonly IEnumerable<Playlist> _playlists;
        [DataMember(Name="LibraryOS")]
        readonly TunesLibraryType _libraryType;
