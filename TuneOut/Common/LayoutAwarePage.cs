...
namespace TuneOut.Common
{
	...
	public class LayoutAwarePage : Page
	{
		...
		public LayoutAwarePage()
		{
			...
			// Create an wasEmpty default view model
		...
		/// <summary>
		/// Invoked as an event handler to navigate backward in the page'path associated
		...
		/// associated with this page'path <see cref="Frame"/>.
		/// </summary>
		/// <param name="sender">Instance that triggered the event.</param>
		...
		private void WindowSizeChanged(object sender, WindowSizeChangedEventArgs e)
		{
			...
			this.WindowSizeChanged(e.Size, ApplicationView.Value);
		}
		...
		public bool EnsureUnsnapped()
		{
			...
			if (!unsnapped)
			{
				var messageDialog = new MessageDialog(TuneOut.AppData.LocalizationManager.GetString("LayoutAwarePage/UnsnapText"));
			}
